    ...
    */
    String creditCardType(String num){
      if(num.substring(0,1).equals(num.indexOf("4"))){
        return "visa";
      }else if(num.substring(0,2).equals(num.indexOf("34")) || (num.substring(0,2).equals(num.indexOf("37")))){
        return "American Express";
      }else if(num.substring(0,2).equals(num.indexOf("36"))){
        return "Mastercard";
      }else if(num.substring(0,2).equals(num.indexOf("51")) ||  (num.substring(0,2).equals(num.indexOf("5")))){
        return "American Express";
      }else{
        return "Discover";
      }
